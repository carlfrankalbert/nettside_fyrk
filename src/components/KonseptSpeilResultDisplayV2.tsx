    ...
    <div className="space-y-6">
      ...
      {parsed.antagelserListe.length > 0 && (
        <section className="p-5 bg-amber-50/50 border border-amber-200/60 rounded-xl">
          <button
            ...
            className="w-full flex items-center justify-between text-left focus:outline-hidden focus:ring-2 focus:ring-brand-cyan-darker focus:ring-offset-2 rounded-sm"
          >
      ...
      {!isStreaming && parsed.isComplete && (
        <section className="p-4 bg-neutral-50 border border-neutral-200 rounded-lg flex items-center justify-between gap-4">
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center px-4 py-2 text-sm font-medium text-brand-navy hover:text-brand-cyan-darker transition-colors focus:outline-hidden focus:ring-2 focus:ring-brand-cyan-darker focus:ring-offset-2 rounded-sm"
          >
            {CONTACT_LABEL}
          </a>
        </section>
      ...
      {!isStreaming && parsed.isComplete && (
        <div className="text-center pt-2">
          <a
            href="/"
            className="text-sm text-neutral-500 hover:text-brand-navy transition-colors focus:outline-hidden focus:ring-2 focus:ring-brand-cyan-darker focus:ring-offset-2 rounded-sm"
          >
            ← Tilbake til FYRK
          </a>
        </div>
