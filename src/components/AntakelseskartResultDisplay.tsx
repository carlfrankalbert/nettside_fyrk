      ...
      {!isStreaming && parsed.isComplete && (
        <div className="flex items-center justify-between p-4 bg-brand-cyan-lightest/40 border border-brand-cyan/30 rounded-xl">
          ...
          <button
            ...
            className={cn(
              'px-4 py-2 text-sm font-medium rounded-lg transition-colors focus:outline-hidden focus:ring-2 focus:ring-brand-cyan-darker focus:ring-offset-2',
              showAssignments
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-2 sm:gap-3 pt-2">
          {onEdit && (
            <button
              type="button"
              onClick={onEdit}
              className="col-span-2 sm:col-span-1 inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-semibold text-white bg-brand-navy hover:bg-brand-navy/90 rounded-lg transition-colors focus:outline-hidden focus:ring-2 focus:ring-brand-cyan-darker focus:ring-offset-2"
            >
          ...
          {parsed.isComplete && (
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-neutral-600 bg-neutral-100 hover:bg-neutral-200 rounded-lg transition-colors focus:outline-hidden focus:ring-2 focus:ring-brand-cyan-darker focus:ring-offset-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {onReset && (
            <button
              type="button"
              onClick={onReset}
              className="inline-flex items-center justify-center px-4 py-2.5 text-sm font-medium text-neutral-500 hover:text-neutral-700 underline underline-offset-2 transition-colors focus:outline-hidden focus:ring-2 focus:ring-brand-cyan-darker focus:ring-offset-2 rounded-sm"
            >
              Start på nytt
            </button>
          )}
