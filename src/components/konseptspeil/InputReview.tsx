  ...
  return (
    <div className="mb-6">
      <button
        ...
        className="w-full flex items-start justify-between gap-3 py-2 text-left focus:outline-hidden focus:ring-2 focus:ring-brand-cyan-darker focus:ring-offset-2 rounded-lg"
      >
